...
(function() {
  ...
  var dart = [["_foreign_helper", "dart:_foreign_helper",, H, {
    ...
    Fibonacci_calculate: function(n) {
      var t1, current, previous, i, next;
      t1 = J.getInterceptor(n);
      if (t1.$eq(n, 0) || t1.$eq(n, 1))
        return n;
      if (typeof n !== "number")
        return H.iae(n);
      current = 1;
      previous = 1;
      i = 2;
      for (; i < n; ++i, previous = current, current = next)
    ...
    NoSuchMethodError_toString_closure: {
      "^": "Closure:7;_box_0,_captured_sb_1",
  ...
  $ = new Isolate();
  init.metadata = [];
  init.types = [{func: 1}, {func: 1, void: true}, {func: 1, args: [,]}, {func: 1, void: true, args: [{func: 1, void: true}]}, {func: 1, ret: P.String, args: [P.$int]}, {func: 1, args: [{func: 1, void: true}]}, {func: 1, args: [,,]}, {func: 1, args: [P.Symbol,,]}, {func: 1, args: [[P.List, P.String], P.SendPort]}];
  ...
  (function(callback) {
    ...
    if (typeof dartMainRunner === "function")
      dartMainRunner(function(a) {
        H.startRootIsolate(S.fibonacci__main$closure(), a);
      }, []);
    else
      (function(a) {
        H.startRootIsolate(S.fibonacci__main$closure(), a);
